...
- LINKS: weave 2-4 internal links as markdown to sibling topics using paths like [text](/movies/<slug>/) or [text](/reviews/<slug>/); and cite >=3 authoritative EXTERNAL primary sources inline and/or in a final "## Sources" list. NEVER link competitors (THR, Variety, Deadline, ScreenRant, Collider, IGN).
