...
// G) the writer is INSTRUCTED correctly (pure prompt build — no LLM spend)
{
  ...
  check("prompt keeps checkable specifics sacred + bars false-confirm", /SPECIFICS ARE SACRED/i.test(system) && /NOT CONFIRMED/i.test(system) && /ONLY facts and quotes you may use/i.test(user));
