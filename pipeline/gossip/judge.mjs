...
- SAFETY/ACCURACY (most important): EVERY claim about a person is attributed ("per [Outlet]", "a source says", "fans noticed") or framed as opinion/speculation — NEVER stated as the writer's own fact; NO fact, quote, number, or name that is not supported by the SOURCE BUNDLE; the non-confirmation note is present when the story is unconfirmed; no damaging assertion stated as fact. Penalize HARD any unattributed damaging claim or any specific not in the bundle.
