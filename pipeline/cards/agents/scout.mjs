...
RULES: topTopic = the ONE story cluster with the most independent headlines (the day's dominant conversation). stories = up to 14 distinct card-able stories; give the dominant topic 5-7 DISTINCT angles (each angle is a different fact, not a rewording) and the rest to other fresh stories, favoring movies/box-office. Use ONLY the given headlines/links — never invent a story. sourceLinks = EVERY given link whose headline covers this story, up to 5 (more links = more verifiable; one-link stories usually get dropped downstream). viral = would a fan DM this to a friend. hint: "box-office" ONLY for money already earned (grosses/records) — presales, tracking, ticket demand for unreleased films are "news". Deaths/tragedy = "memoriam".`;
