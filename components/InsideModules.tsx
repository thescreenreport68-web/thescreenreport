...
export function InsideBottom({ article }: { article: Article }) {
  if (article.formatTag !== "inside") return null;
  // REV 3: Instagram posts render INLINE in the body (below the paragraph quoting them) via
  // ArticleBody's embed markers — the bottom strip is retired; cards remain for non-embedded voices.
