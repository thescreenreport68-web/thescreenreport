---
title: 12 States Sue to Block Paramount-Warner Bros
slug: 12-states-sue-to-block-paramount-warner-bros
category: movies
subcategory: reactions
author: editorial-team
date: '2026-07-13T20:31:12.847Z'
dek: >-
  A major lawsuit to block the Paramount-Warner Bros. merger has ignited a
  fierce online debate, with fans, workers, and officials split on whether the
  deal is a job-killing monopoly or the only way to compete with Netflix.
...
keyTakeaways:
  - >-
    Opponents argue the merger would create an illegal monopoly, raise prices,
    and cost thousands of entertainment jobs.
  - >-
    The lawsuit creates a rare public split between state law enforcers and the
    federal DOJ on antitrust policy.
faq:
  - q: Which states are part of the lawsuit against the merger?
    a: >-
      The lawsuit is led by California Attorney General Rob Bonta and includes
      Arizona, California, Colorado, Connecticut, Massachusetts, Minnesota,
      Nevada, New Jersey, New Mexico, New York, Oregon, and Washington.
about:
  - name: Paramount
    type: Organization
...
parentEventSlug: movie-theaters-group-backs-lawsuit-to-block-paramount-merger
parentTitle: Movie Theaters Group Backs Lawsuit to Block Paramount Merger With Warner Bros.
reactions:
  - speaker: A viewer
    date: '2026-07-09'
    quote: >-
      A judge is looking into the Paramount-Warner Bros. Merger to see if It
      forms an entertainment monopoly which is illegal. IT DOES! Movie fans do
      not want only 1 giant studio monopolizing all entertainment.
  - speaker: Rob Bonta
    connection: Attorney General of California
    platform: statement
    quote: >-
      Giving that much power to one media company would wipe out competition,
      jack up prices, hurt the quality of content we’re offered, and bring fewer
      movies and shows to our screens.
  - speaker: AG Andrea Joy Campbell
    date: '2026-07-13'
    quote: >-
      BREAKING: My office is suing Paramount/Warner Bros to block their proposed
      $110 billion merger. Combining the two Hollywood giants would unlawfully
      reduce competition in the film and tv industry and raise prices for
      consumers. You shouldn't have to pay the price of corporate greed.
  - speaker: Tom Fontana
    connection: Writers Guild of America East president
    platform: statement
    quote: >-
      The proposed Paramount Skydance merger with Warner Bros. Discovery would
      create an alarming amount of consolidation and contraction and cause
      irreparable harm to our members. People will lose their jobs, their
      income, their homes. The damage this deal would do to America’s
      entertainment and news industries would be an absolute, unmitigated
      disaster.
  - speaker: Paramount
    platform: statement
    quote: >-
      ...
      industry for audiences, premium content, and creative talent.
  - speaker: Paramount
    platform: statement
    quote: >-
      The practical effect of this lawsuit is to shield those dominant streaming
      platforms like Netflix and technology companies from much needed
      competition while preventing the significant benefits this transaction
      will deliver for consumers, creators, workers, and the broader Hollywood
      economy.
fanConsensus: >-
  The reaction is sharply divided, with one side viewing the merger as a
  dangerous, job-killing monopoly and the other seeing it as a necessary
  consolidation for survival against streaming giants.
updatedCount: 0
trendScore: 45
signals:
  outlets: 6
  ...
  families: 1
eventSlug: >-
  movie-theaters-group-backs-lawsuit-to-block-paramount-merger--in-audience-reaction
eventType: discourse
outletCount: 3
developing: true
aiDisclosure: >-
  ...
  analysis is our own.
dateModified: '2026-07-13T20:31:12.847Z'
provenance:
  parentEventSlug: movie-theaters-group-backs-lawsuit-to-block-paramount-merger
  primaryEntity: Movie Theaters Group Backs Lawsuit
  eventType: discourse
  monitor: true
  monitorWindowH: 72
  anchors: 15
  publishedAt: '2026-07-13T20:31:12.847Z'
image: >-
  https://www.hollywoodreporter.com/wp-content/uploads/2026/05/GettyImages-2263964771.jpg?w=1600&h=900&crop=1
imageAlt: Paramount Warner Bros merger lawsuit news conference
