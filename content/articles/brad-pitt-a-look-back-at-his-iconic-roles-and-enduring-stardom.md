...
dek: >-
  From heartthrob to Oscar winner, we trace the star's three-decade journey
  through his most defining films and the performances that built his legacy.
metaTitle: 'Brad Pitt Movies: Iconic Roles and Career Evolution'
metaDescription: >-
  Explore Brad Pitt's iconic movie roles, from Thelma & Louise to Once Upon a
  Time... in Hollywood, and his evolution into one of Hollywood's most enduring
  stars.
tags:
  - brad pitt
  - hollywood
  ...
  - career
  - films
targetKeyword: brad pitt movies
keyTakeaways:
  - >-
    Brad Pitt's films have grossed over $7.5 billion worldwide, cementing his
    box-office power.
  - >-
    He won an Academy Award for Best Supporting Actor for Once Upon a Time... in
    Hollywood.
  - >-
    Pitt's career spans from early heartthrob roles in Legends of the Fall to
    character-driven work in Fight Club and Moneyball.
  - >-
    His filmography shows a deliberate shift from leading man to producer and
    character actor.
  - >-
    He first gained major recognition as a hitchhiker in Ridley Scott's 1991
    film Thelma & Louise.
faq:
  - q: What was Brad Pitt's first major movie role?
    a: >-
      While he had small parts before it, Pitt's first major role that brought
      him widespread recognition was as the cowboy hitchhiker J.D. in Ridley
      Scott's 1991 film Thelma & Louise. His brief but magnetic performance in
      the film made him an instant sensation and launched his career as a
      leading man.
  - q: How many Oscars has Brad Pitt won?
    a: >-
      Brad Pitt has won one Academy Award for acting. He won the Oscar for Best
      Supporting Actor for his role as Cliff Booth in Quentin Tarantino's Once
      Upon a Time... in Hollywood (2019). Through his production company, Plan
      B, he also holds a Best Picture Oscar for producing 12 Years a Slave.
  - q: What is considered Brad Pitt's best performance?
    a: >-
      This is highly subjective, but his Oscar-winning turn in Once Upon a
      Time... in Hollywood is a masterclass in relaxed, charismatic character
      acting. Many critics also point to his intense work in Fight Club, his
      nuanced portrayal in Moneyball, or his early, heartbreaking role in
      Legends of the Fall as peak performances. Each showcases a different facet
      of his considerable range.
  - q: Does Brad Pitt do his own stunts?
    a: >-
      Pitt is known for performing many of his own stunts, a commitment that
      adds physical authenticity to his roles. He trained extensively in
      fighting for Fight Club and Snatch, and performed driving stunts for Once
      Upon a Time... in Hollywood. His background as a stuntman's double early
      in his career gave him a foundation and respect for the craft that has
      persisted throughout his stardom.
about:
  ...
  - name: Thelma & Louise
    type: Movie
imageAlt: 'Brad Pitt — Brad Pitt Movies: The Evolution of a Hollywood Icon'
imageCredit: LucaFazPhoto / Wikimedia Commons / CC BY-SA 4.0
image: >-
  /images/articles/brad-pitt-a-look-back-at-his-iconic-roles-and-enduring-stardom.jpg
imageWidth: 1563
imageHeight: 2778
formatTag: profile
factPanel:
...
filmography:
  ...
  - year: '2017'
    title: War Machine
    role: Gen. Glen McMahon
    type: Film
careerStats:
  - label: Oscar Wins (Acting)
    value: '1'
  - label: Oscar Nominations (Acting)
    value: '4'
  - label: Worldwide Box Office (Leading Roles)
    value: $7.5+ billion
methodology: >-
  This profile was compiled using verified filmography data, official Academy
  Award records, and confirmed career milestones. No direct interview was
...
## Sources
- [Academy Awards Database](https://www.oscars.org/)
