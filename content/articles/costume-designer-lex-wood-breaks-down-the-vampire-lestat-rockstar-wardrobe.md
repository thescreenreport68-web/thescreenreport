---
title: Costume Designer Lex Wood Breaks Down 'The Vampire Lestat' Rockstar Wardrobe
slug: costume-designer-lex-wood-breaks-down-the-vampire-lestat-rockstar-wardrobe
category: tv
subcategory: news
author: editorial-team
date: '2026-07-06T21:01:06.109Z'
dek: >-
...
tags:
  ...
  - jacob anderson
  - lestat
targetKeyword: The Vampire Lestat
keyTakeaways:
  - >-
    Costume designer Lex Wood prioritized vibrant color for Lestat's rockstar
    transformation in 'The Vampire Lestat' Season 3.
  - >-
    Inspiration came from artists like Iggy Pop and David Bowie, but the goal
    was to make Lestat's look uniquely his own.
  - >-
    Fabric choices, like silk for Lestat and his mother Gabriella, contain
    hidden Easter eggs connecting them to their past.
  - >-
    Louis's layered wardrobe reflects his attempt to appear 'fixed' and
    integrated into society after traumatic events.
  - >-
    Regina's waitress uniform is a deliberate nod to the yellow dress Claudia
    died in, a key emotional detail.
faq:
  - q: Where can I watch 'The Vampire Lestat' season?
    a: >-
      According to verified platform data, the series 'Interview with the
      Vampire' (which includes the season subtitled 'The Vampire Lestat') is
      currently streaming in the U.S. on services including Netflix, AMC+, and
      YouTube TV.
  - q: Who plays Lestat in the series?
    a: >-
      Sam Reid plays the vampire Lestat de Lioncourt in the AMC+ series
      'Interview with the Vampire'.
  - q: How many seasons of 'Interview with the Vampire' are there?
    a: >-
      The series began in 2022, and the interview with costume designer Lex Wood
      discusses her work on the show's third season, which is subtitled 'The
      Vampire Lestat'.
about:
...
signals:
  ...
  big: 8
  trending: 0
eventSlug: the-vampire-lestat-costume-designer-lestat-wardrobe-easter-eggs
eventType: other
outletCount: 1
provenance:
  eventSlug: the-vampire-lestat-costume-designer-lestat-wardrobe-easter-eggs
  primaryEntity: Lex Wood
  eventType: other
  sensitivity: normal
  status: DEVELOPING
  ...
  outlets:
    - Variety
  publishedAt: '2026-07-06T21:01:06.109Z'
dateModified: '2026-07-06T21:01:06.109Z'
storyStatus: DEVELOPING
newsType: general
pullQuote:
  text: >-
    A lot of the actual design we were doing as we were going. We had some
    pieces I designed before we started, but a lot of it, we’re doing on the
    hoof, because we’re responding to the script.
  attribution: 'Costume designer Lex Wood, to Variety'
keyPoints:
  - >-
    Costume designer Lex Wood discussed the rockstar-inspired wardrobe for 'The
    Vampire Lestat' season.
  - >-
    She revealed hidden Easter eggs in fabric choices and character-specific
    jewelry.
  - >-
    The interview breaks down how costumes reflect the emotional states of
    Lestat, Louis, and Regina.
seriesContext:
  network: AMC
  premiere: '2022'
...
## What Inspired Lestat's Rockstar Look?
