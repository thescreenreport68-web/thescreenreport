---
title: The 'Minions & Monsters' Trailer Teases a Wild 1920s Hollywood Origin Story
slug: minions-monsters-trailer-drops-promises-wild-hollywood-origin-story
category: movies
subcategory: trailers
author: editorial-team
date: '2026-06-26T14:01:03.352Z'
dek: >-
  The third Minions prequel sends the little yellow henchmen to 1920s Hollywood,
  where they become silent film stars before accidentally unleashing cinematic
  chaos.
metaTitle: Minions & Monsters Trailer Drops for 2026 Animated Comedy
metaDescription: >-
  The Minions & Monsters trailer reveals a 1926 animated comedy where the
  Minions conquer Old Hollywood, lose it all, and must stop monsters they
  unleashed.
tags:
  - minions
  - monsters
  ...
  - hollywood
  - animation
targetKeyword: minions and monsters trailer
keyTakeaways:
  - >-
    The film is a prequel set in 1920, 48 years before the events of 'Minions'
    (2015).
  - >-
    Pierre Coffin returns to direct and voice the Minions, with a star-studded
    voice cast including Trey Parker and Christoph Waltz.
  - >-
    The plot follows the Minions becoming silent film stars, failing in the
    talkie era, and making their own monster movie.
  - 'It premieres in theaters on July 1, 2026, after a festival debut in Annecy.'
  - >-
    The film is a love letter to classic Hollywood, packed with homages to early
    cinema.
faq:
  - q: Is Minions & Monsters connected to Gru's story?
    a: >-
      Only indirectly. The film follows a separate tribe of Minions in 1920,
      decades before they meet Gru. It's an origin story for Minion culture and
      their love of cinema, not a direct lead-in to Gru's villainy. The film
      exists to expand the world's lore independently.
  - q: What classic film references are in Minions & Monsters?
    a: >-
      The references are extensive. The opening credits insert Minions into
      historic silent films like *A Trip to the Moon*. Visual gags parody
      Charlie Chaplin's *Modern Times* and Harold Lloyd's *Safety Last!*. There
      are nods to *Citizen Kane*, *Casablanca*, and monster movie iconography.
      The film museum setting displays statues of E.T., *Metropolis*, and
      *Jaws*.
  - q: Will Minions & Monsters stream on Netflix?
    a: >-
      Yes, eventually. As part of Universal's deal, the film will stream first
      on Peacock for four months after its pay-TV window, then move to Netflix
      for ten months, before returning to Peacock. It will have a standard
      theatrical run first, premiering on July 1, 2026.
  - q: Who composed the music for the film?
    a: >-
      John Powell composed the score. This is his third project with
      Illumination after *The Lorax* and *Migration*, and it marks a break from
      franchise tradition—it's the first *Despicable Me* or *Minions* film not
      scored by the series' usual composer, Heitor Pereira.
about:
  - name: Minions & Monsters
    type: Movie
    sameAs: 'https://en.wikipedia.org/wiki/Minions_%26_Monsters'
imageAlt: >-
  Pierre Coffin — The 'Minions & Monsters' Trailer Teases a Wild 1920s Hollywood
  Origin Story
imageCredit: Stanzilla / Wikimedia Commons / CC BY-SA 3.0
image: >-
  /images/articles/minions-monsters-trailer-drops-promises-wild-hollywood-origin-story.jpg
imageWidth: 1920
imageHeight: 1278
formatTag: trailer
youtubeId: ZSdOwt-G49w
releaseInfo: 'July 1, 2026'
keyMoments:
  ...
  - >-
    Third film in the Minions prequel series, seventh in the Despicable Me
    franchise.
