---
title: >-
  Why Audiences Are Underwhelmed by 'Moana' – And It's Not Just About One
  Weekend
slug: why-audiences-are-underwhelmed-by-moana-and-it-s-not-just-about-one-weekend
category: movies
subcategory: reactions
author: editorial-team
date: '2026-07-12T18:31:15.260Z'
dek: >-
  Disney's live-action 'Moana' didn't dominate the box office, but the real
  story is a wave of audience frustration aimed squarely at the studio's remake
  strategy.
...
keyTakeaways:
  - >-
    The live-action 'Moana' underperformed at the box office, failing to
    dominate a crowded family-film market.
  - >-
    Audience discourse is less about this film's quality and more about a
    broader backlash to Disney's live-action remake strategy.
  - >-
    One pointed fan critique uses 'Lilo & Stitch' as an example of how remakes
    can betray a film's core themes.
  - >-
    Analysts suggest market saturation, not just franchise fatigue, played a
    role in the film's opening weekend.
faq:
  - q: How did the live-action 'Moana' perform at the box office?
    a: >-
      The film had an underwhelming opening weekend, failing to dominate the
      market as expected. Analysts noted it faced stiff competition from two
      other major family films, suggesting market saturation played a role in
      its performance.
  - q: What is the main criticism from audiences about the 'Moana' remake?
    a: >-
      The dominant criticism isn't specifically about 'Moana' but about Disney's
      live-action remake strategy as a whole. Fans express frustration that
      these remakes often betray the core themes and emotional authenticity of
      the original animated classics, citing concerns over projects like the
      upcoming 'Lilo & Stitch.'
  - q: Are audiences just tired of Disney remakes?
    a: >-
      Analyst Paul Dergarabedian suggested the underperformance might be due to
      a crowded market rather than simple "family movie fatigue." However,
      audience discourse strongly indicates a deeper creative resentment and
      franchise fatigue with the remake formula itself, beyond any one film's
      release date.
about:
  - name: Moana (2025 film)
    type: Movie
  - name: The Walt Disney Company
    type: Organization
  - name: Paul Dergarabedian
    type: Person
formatTag: inside
insideForm: audience-reaction
parentEventSlug: disney-s-live-action-moana-crashes-to-shore-with-an-underwhe
parentTitle: >-
  Disney's live-action 'Moana' crashes to shore with an underwhelming splash at
  the box office - AP News
reactions:
  - speaker: A viewer
    date: '2026-07-08'
    quote: >-
      Disneys Live-Action Moana: First Reactions From Premiere Moana, Disney‘s
      latest live-action remake of one of its beloved animated classics, held
      its world premiere at the iconic Hollywood Bowl, Los Angeles on Tuesday
      night, and not long after the screening early reaction to the film hit
  - speaker: Paul Dergarabedian
    connection: head of marketplace trends for Rentrak
    platform: interview
    quote: 'Families love going to the movies, but right now there are three of them,'
  - speaker: Paul Dergarabedian
    connection: head of marketplace trends for Rentrak
    platform: interview
    quote: >-
      Moana ’s performance may not be a case of “family movie fatigue,” he said,
      but simply shows there can be a ceiling.
  - speaker: A viewer
    date: '2026-07-08'
    quote: >-
      Not much difference tbh, im just still pissed they completely ruined L&S
      with that live action. The whole message of found family, community, anti
      colonialism and Lilo and Nanis bond as sisters made it an amazing movie.
      But nah, send Nani to the continental 48
fanConsensus: >-
  Audiences are using the live-action 'Moana's performance as a launchpad to
  express deep-seated frustration with Disney's remake strategy, fearing it
  betrays the heart of their beloved stories.
updatedCount: 0
trendScore: 45
signals:
  outlets: 4
  ...
  families: 1
eventSlug: >-
  disney-s-live-action-moana-crashes-to-shore-with-an-underwhe--in-audience-reaction
eventType: discourse
outletCount: 6
developing: true
aiDisclosure: >-
  ...
  analysis is our own.
dateModified: '2026-07-12T18:31:15.260Z'
provenance:
  parentEventSlug: disney-s-live-action-moana-crashes-to-shore-with-an-underwhe
  primaryEntity: s live-action
  eventType: discourse
  monitor: true
  monitorWindowH: 72
  anchors: 4
  publishedAt: '2026-07-12T18:31:15.260Z'
image: >-
  https://www.billboard.com/wp-content/uploads/2026/07/moana-premiere-2026-billboard-1800.jpg?w=1600
imageAlt: Disney live action Moana 2025 film poster
imageCredit: Photo via PMC
imageWidth: 1600
imageHeight: 1066
---

Disney's live-action '[Moana](/movies/catherine-laga-aia-and-dwayne-johnson-lead-moana-live-action-cast/)' sailed into a crowded family-film market and failed to dominate, but audience discourse reveals deeper discontent with the studio's remake strategy than with this one underwhelming weekend. The conversation online is less a review of this specific voyage and more a referendum on a familiar, and increasingly frustrating, corporate course.
...
## The Audience's Broader Frustration
