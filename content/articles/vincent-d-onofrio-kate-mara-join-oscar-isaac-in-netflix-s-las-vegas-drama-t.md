...
title: >-
  ...
  'The Roman'
slug: vincent-d-onofrio-kate-mara-join-oscar-isaac-in-netflix-s-las-vegas-drama-t
category: tv
subcategory: news
author: editorial-team
date: '2026-07-15T23:00:58.987Z'
dek: >-
...
tags:
  - the roman netflix series
  - the roman
  - vincent d'onofrio
  - kate mara
  - clancy brown
  - netflix
targetKeyword: the roman netflix series
keyTakeaways:
  - >-
    Vincent D'Onofrio and Kate Mara are series regulars in the new Netflix
    drama.
  - >-
    The show is an eight-episode series set in the modern Las Vegas casino
    business.
  - >-
    Oscar Isaac stars and executive produces, with Martin Scorsese also serving
    as an executive producer.
  - >-
    Brian Koppelman and David Levien created the series and serve as
    showrunners.
faq:
  - q: How many episodes will The Roman have?
    a: The series is planned as an eight-episode drama.
  - q: Who is the showrunner for The Roman?
    a: >-
      Brian Koppelman and David Levien, the series creators, are the
      showrunners, writers, and executive producers.
  - q: Is The Roman based on a true story or a book?
    a: >-
      No, the series is an original drama created by Brian Koppelman and David
      Levien, set in the fictionalized, high-stakes world of modern Las Vegas
      casinos.
about:
  - name: The Roman
    type: TV Show
...
signals:
  ...
  trending: 8
  softTv: 0
eventSlug: the-roman-netflix-series-casting
eventType: casting
outletCount: 2
provenance:
  eventSlug: the-roman-netflix-series-casting
  primaryEntity: The Roman
  eventType: casting
  sensitivity: normal
  status: DEVELOPING
  ...
  outlets:
    - Variety
    - Deadline
  publishedAt: '2026-07-15T23:00:58.987Z'
dateModified: '2026-07-15T23:00:58.987Z'
storyStatus: DEVELOPING
newsType: general
pullQuote:
  text: >-
    An hour-long drama set in the high-stakes, sharp-elbowed present-day Las
    Vegas casino business, which is a modernized but still dangerous version of
    the legendary city.
  attribution: Series logline reported by Variety
keyPoints:
  - Five new actors have joined the cast of Netflix's The Roman.
  - Vincent D'Onofrio and Kate Mara will be series regulars.
  - The series is executive produced by Oscar Isaac and Martin Scorsese.
seriesContext:
  network: Netflix
  premiere: ''
  status: Upcoming
