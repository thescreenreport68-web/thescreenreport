---
title: Ryan Reynolds & Kenneth Branagh Team Up in Apple's 'Mayday' Trailer
slug: ryan-reynolds-kenneth-branagh-team-up-in-apple-s-mayday-trailer
category: movies
subcategory: trailers
author: editorial-team
date: '2026-07-16T16:58:54.110Z'
dek: >-
...
tags:
  ...
  - kenneth branagh
  - apple tv
targetKeyword: mayday trailer
keyTakeaways:
  - >-
    Apple has released the official trailer for the action-comedy 'Mayday,'
...
faq:
  ...
  - q: What kind of movie is 'Mayday'?
    a: >-
      ...
      flips the spy thriller on its head. The official synopsis confirms its
      adventure, comedy, and action genres, set against the backdrop of the Cold
      War.
  - q: Will 'Mayday' be in theaters?
    a: >-
      No. According to the release information, “Mayday” is a streaming-original
      film for Apple TV. It is scheduled to premiere directly on the platform in
      September 2026 with no announced theatrical run.
  - q: Who plays the ex-KGB agent?
    a: >-
      Kenneth Branagh portrays Nikolai Ustinov, the eccentric former KGB agent
      who forms an unlikely partnership with Ryan Reynolds’s stranded Navy
      pilot.
about:
  - name: Mayday
    type: Movie
...
signals:
  ...
  trending: 0
  softTv: 0
eventSlug: mayday-trailer-release
eventType: trailer
outletCount: 1
provenance:
  eventSlug: mayday-trailer-release
  primaryEntity: Mayday
  eventType: trailer
  sensitivity: normal
  status: DEVELOPING
  ...
  outlets:
    - Apple
  publishedAt: '2026-07-16T16:58:54.110Z'
...
keyMoments:
  ...
  - >-
    The film is an Apple Original set for a global streaming premiere in
    September 2026.
reveals:
  - term: Premise
    note: >-
      A U.S. Navy pilot must ally with an ex-KGB agent to survive behind enemy
      lines.
  - term: Main Cast
    note: >-
      Ryan Reynolds as Troy Kelly and Kenneth Branagh as Nikolai Ustinov are
      confirmed.
  - term: Release Platform
    note: The film is an Apple Original and will stream exclusively on Apple TV.
officialSynopsis: >-
  When a U.S. Navy pilot on a top-secret mission during the Cold War gets
  trapped behind enemy lines, his only chance at survival is to form an alliance
  with an eccentric ex-KGB agent.
---
