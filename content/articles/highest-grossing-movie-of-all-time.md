...
faq:
  ...
  - q: What is the highest grossing movie of all time adjusted for inflation?
    a: >-
      ...
      adjusted for inflation. Guinness World Records puts it at about $3.44
      billion in today's dollars, and broader estimates that include all
      re-releases reach $4.5 billion or more. Its 1939 ticket prices were a
      fraction of modern ones, so its enormous attendance translates to a far
      higher inflation-adjusted total than Avatar.
  - q: 'Did Avengers: Endgame beat Avatar at the box office?'
    a: >-
      ...
      2021 thanks to a China re-release. Endgame finished at about $2.80
      billion, just behind Avatar's $2.92 billion.
  - q: What are the top 10 highest grossing movies of all time?
    a: >-
      By nominal worldwide gross, the top 10 are: 1. Avatar (~$2.92B), 2.
      Avengers: Endgame (~$2.80B), 3. Avatar: The Way of Water (~$2.33B), 4.
      Titanic (~$2.26B), 5. Ne Zha 2 (~$2.22B), 6. Star Wars: The Force Awakens
      (~$2.07B), 7. Avengers: Infinity War (~$2.05B), 8. Spider-Man: No Way Home
      (~$1.92B), 9. Zootopia 2 (~$1.87B), and 10. Inside Out 2 (~$1.70B). James
      Cameron directed three of the top four.
  - q: How many movies have grossed over $2 billion?
    a: >-
      Exactly seven films have crossed $2 billion worldwide: Avatar, Avengers:
      Endgame, Avatar: The Way of Water, Titanic, Ne Zha 2, Star Wars: The Force
      Awakens, and Avengers: Infinity War. The $2 billion club only opened in
      2019; before that, Avatar stood alone above the mark for nearly a decade.
  - q: What is the highest grossing movie franchise of all time?
    a: >-
      The Marvel Cinematic Universe is the highest-grossing film franchise of
      all time, having amassed over $32 billion across nearly 40 films. No
      single picture comes close, and the MCU also has the most billion-dollar
      individual movies of any series. Behind it sit Star Wars, the Wizarding
      World of Harry Potter, and James Bond.
  - q: Is Ne Zha 2 one of the highest grossing movies of all time?
    a: >-
      Yes. Ne Zha 2 (2025), a Chinese animated blockbuster, has grossed roughly
      $2.22 billion worldwide, making it the fifth highest-grossing film of all
      time and the highest-grossing animated film ever. Most of its earnings
      came from China, proving the global box office is no longer a
      Hollywood-only race.
featured: false
image: /images/articles/highest-grossing-movie-of-all-time.jpg
keyTakeaways:
  - >-
    Avatar (2009) is the highest-grossing movie of all time at roughly $2.92
    billion worldwide (about $2,923,710,708 on Box Office Mojo), not adjusted
    for inflation.
  - >-
    Avatar lost the crown to Avengers: Endgame in July 2019, then reclaimed it
    in March 2021 after a China re-release; Endgame finished at about $2.80
    billion.
  - >-
    Adjusted for inflation, Gone with the Wind (1939) is the true money king,
    with an estimated $3.4 billion (Guinness) to $4.5 billion-plus in today's
    dollars.
  - >-
    Seven films have crossed $2 billion worldwide; James Cameron directed three
    of the top four (Avatar, Titanic, The Way of Water).
  - >-
    The Marvel Cinematic Universe is the highest-grossing franchise ever at over
    $32 billion, far beyond any single film.
about:
  - name: Avatar
    type: Movie
    sameAs: 'https://en.wikipedia.org/wiki/Avatar_(2009_film)'
  - name: 'Avengers: Endgame'
    type: Movie
    sameAs: 'https://en.wikipedia.org/wiki/Avengers:_Endgame'
  - name: 'Avatar: The Way of Water'
    type: Movie
    sameAs: 'https://en.wikipedia.org/wiki/Avatar:_The_Way_of_Water'
  - name: Titanic
    type: Movie
    sameAs: 'https://en.wikipedia.org/wiki/Titanic_(1997_film)'
...
**Further reading:** [James Cameron on Wikipedia](https://en.wikipedia.org/wiki/James_Cameron) · Where to watch on JustWatch.

## Sources

- [Box Office Mojo - Top Lifetime Grosses (Worldwide)](https://www.boxofficemojo.com/chart/ww_top_lifetime_gross/)
- [Wikipedia - List of highest-grossing films](https://en.wikipedia.org/wiki/List_of_highest-grossing_films)
- [Box Office Mojo - Gone with the Wind](https://www.boxofficemojo.com/title/tt0031381/)
- [Wikipedia - Avatar (2009 film)](https://en.wikipedia.org/wiki/Avatar_(2009_film))
- [Guinness World Records - Highest box office film gross (inflation-adjusted)](https://www.guinnessworldrecords.com/world-records/highest-box-office-film-gross-inflation-adjusted)
