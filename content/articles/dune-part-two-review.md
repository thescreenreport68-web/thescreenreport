...
faq:
  - q: 'Is Dune: Part Two worth watching?'
    a: >-
      Yes. It holds a 92% Rotten Tomatoes critics score across 465-plus reviews,
      plus a 95% audience score, and it improves on the 2021 original in nearly
  ...
  - q: 'Is Dune: Part Two better than the first movie?'
    a: >-
      ...
      Two versus 83% for the original. Part Two also out-grossed the entire run
      of the first film.
  - q: 'What is Dune: Part Two''s Rotten Tomatoes score?'
    a: >-
      Dune: Part Two holds a 92% Tomatometer score from more than 465 critic
      reviews, alongside a 95% audience (Popcornmeter) score. The critics'
      consensus calls it 'visually thrilling and narratively epic.' By
      comparison, Dune (2021) sits at 83%. The score reflects near-universal
      praise for the film's scale, performances and emotional depth.
  - q: 'How long is Dune: Part Two?'
    a: >-
      The runtime is 166 minutes -- 2 hours and 46 minutes -- as listed on IMDb
      and Box Office Mojo. It is about 11 minutes longer than the 2021 original
      (155 minutes). It earns the length: unlike many bloated blockbusters, Part
      Two uses its runtime to build genuine stakes and rarely drags.
  - q: >-
    ...
    a: >-
      ...
      Dune Messiah, which Denis Villeneuve is directing for a December 18, 2026
      release. Villeneuve also changed Chani's arc from the novel: rather than
      standing beside Paul, she rejects his ascension and rides off alone on a
      sandworm, sharpening the film's critique of the white-savior myth and
      Paul's turn into a darker messianic figure.
  - q: 'Do you need to watch Dune: Part One before Part Two?'
    a: >-
      Yes. Part Two assumes you already know the characters, the politics of
      Arrakis and what the spice means -- it does not pause to recap. Rewatching
      Dune (2021) first will make the stakes, relationships and prophecy land
      far harder. Newcomers can technically follow the broad strokes, but the
      emotional payoff depends on the groundwork the first film lays.
  - q: 'How much did Dune: Part Two make at the box office?'
    a: >-
      Dune: Part Two grossed approximately $714.8 million worldwide -- about
      $282.1 million domestically and $432.7 million internationally, per Box
      Office Mojo. That total surpassed the entire global run of the 2021
      original, confirming the sequel as both a critical and commercial success
      and helping greenlight the planned third film.
  - q: 'Who is in the cast of Dune: Part Two?'
    a: >-
      Timothee Chalamet returns as Paul Atreides and Zendaya as Chani, joined by
      Rebecca Ferguson (Lady Jessica), Javier Bardem (Stilgar) and Josh Brolin
      (Gurney Halleck). New additions include Austin Butler as the menacing
      Feyd-Rautha, Florence Pugh as Princess Irulan, Christopher Walken as the
      Emperor and Lea Seydoux. Butler's villain and Zendaya's expanded role are
      widely cited as the film's standout additions.
featured: false
image: /images/articles/dune-part-two-review.jpg
keyTakeaways:
  - >-
    Verdict: Dune: Part Two is the rare sequel that surpasses its predecessor,
    earning a 9.5/10 -- darker, faster and more emotionally charged than Dune
    (2021).
  - >-
    It holds a 92% Rotten Tomatoes critics score (across 465-plus reviews) and a
    95% audience score, a clear jump over the original's 83%.
  - >-
    Runtime is 166 minutes (2h 46m), about 11 minutes longer than the first
    film, and it uses the length to build real stakes rather than spectacle
    alone.
  - >-
    The book-deviating ending -- Chani rejecting Paul and riding off alone --
    sharpens the white-savior critique and sets up a third film based on Dune
    Messiah (in development for December 18, 2026).
  - >-
    It grossed roughly $714.8 million worldwide, surpassing the entire run of
    the 2021 original.
about:
  - name: 'Dune: Part Two'
    type: Movie
...
**Further reading:** [Austin Butler on Wikipedia](https://en.wikipedia.org/wiki/Austin_Butler) · Where to watch on JustWatch.

## Sources

- [Dune: Part Two -- Rotten Tomatoes (92% critics score, consensus)](https://www.rottentomatoes.com/m/dune_part_two)
- [Dune: Part Two -- Box Office Mojo (worldwide gross $714.8M, runtime)](https://www.boxofficemojo.com/title/tt15239678/)
- [Dune: Part Two -- Wikipedia (cast, release, runtime, Messiah setup)](https://en.wikipedia.org/wiki/Dune:_Part_Two)
- [Dune (2021 film) -- Wikipedia (original film, 83% RT, 155-min runtime)](https://en.wikipedia.org/wiki/Dune_(2021_film))
- [Dune Messiah -- Wikipedia (basis for the planned third film)](https://en.wikipedia.org/wiki/Dune_Messiah)
