...
slug: california-ag-rob-bonta-denies-cnn-spinoff-would-end-paramount-merger-lawsu
category: movies
subcategory: news
author: editorial-team
date: '2026-07-16T03:00:59.602Z'
dek: >-
  The California attorney general directly refuted a claim by FCC Chair Brendan
  Carr, clarifying he 'never said' dropping the antitrust case was conditional
  on selling CNN.
metaTitle: Rob Bonta Denies CNN Spinoff Would End Paramount
metaDescription: >-
...
keyTakeaways:
  - >-
    ...
    lawsuit if CNN was sold off.
  - >-
    Bonta states spinning off a single channel is 'not a sufficient remedy' to
    protect competition.
  - >-
    The legal challenge, filed Monday, seeks to block the merger between
    Paramount and Warner Bros. Discovery.
  - >-
    FCC Chair Brendan Carr had questioned the antitrust theory behind making the
    case contingent on one cable channel.
faq:
  - q: What is the current status of the lawsuit against the Paramount merger?
    a: >-
      The lawsuit is active and moving forward. California Attorney General Rob
      Bonta, leading 12 states, filed the antitrust challenge on Monday and has
      requested a temporary restraining order and an injunction to halt the
      merger during the litigation.
  - q: How did FCC Chair Brendan Carr respond to Bonta's denial?
    a: >-
      Carr appeared to stand by his original claim. On Wednesday evening, he
      responded to Bonta's post on X with a screenshot from a Puck News report
      that had claimed the California attorney general wanted Paramount to sell
      CNN if the merger proceeded.
  - q: Have any other groups joined the legal action?
    a: >-
      Yes. The Writers Guild of America filed its own separate lawsuit on
...
provenance:
  ...
  outlets:
    - TheWrap
  publishedAt: '2026-07-16T03:00:59.602Z'
dateModified: '2026-07-16T03:00:59.602Z'
...
pullQuote:
  text: >-
    Unsure where this reporting originated from, but I’ve literally never said
    this. Spinning off one channel from a media conglomerate is not a sufficient
    remedy to protect consumers and preserve competition in the film and
    television industry.
  attribution: 'California Attorney General Rob Bonta, in a statement on X'
keyPoints:
  - >-
    California AG Rob Bonta denies a reported claim that selling CNN would end
    the state's antitrust lawsuit.
  - >-
    FCC Chair Brendan Carr had cited news reports suggesting the lawsuit was
    contingent on a CNN spinoff.
  - >-
    Bonta filed the lawsuit Monday leading 12 states, seeking to block the
    Paramount-Warner Bros. Discovery merger.
---
