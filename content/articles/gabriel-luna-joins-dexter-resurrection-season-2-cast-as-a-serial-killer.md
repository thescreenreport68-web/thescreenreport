---
title: 'Gabriel Luna Joins ''Dexter: Resurrection'' Season 2 Cast as a Serial Killer'
slug: gabriel-luna-joins-dexter-resurrection-season-2-cast-as-a-serial-killer
category: tv
subcategory: news
author: editorial-team
date: '2026-07-15T21:00:38.157Z'
dek: >-
...
tags:
  ...
  - dan stevens
  - the last of us
targetKeyword: Dexter Resurrection casting
keyTakeaways:
  - >-
    Gabriel Luna has joined the cast of 'Dexter: Resurrection' for its second
    season.
  - >-
    He will play Ray Ballard, a serial killer known as 'The Sleepy-Eyed
    Stranger.'
  - >-
    Luna joins other new cast members Brian Cox and Dan Stevens in the
    Paramount+ series.
  - >-
    Season one ended with Dexter discovering a file on the 'New York Ripper,'
    setting up new threats.
  - 'The series, starring Michael C. Hall, is currently streaming on Paramount+.'
faq:
  - q: What other TV shows has Gabriel Luna been in?
    a: >-
      Gabriel Luna is known for his role as Tommy Miller in HBO's 'The Last of
      Us,' a part he will return to for its third season. His other recent
      television credits include Peacock's 'Devil in Disguise: John Wayne Gacy,'
      Netflix's 'FUBAR,' and he recently wrapped filming on the second season of
      Prime Video's 'The Terminal List.'
  - q: Who are the main returning cast members for Season 2?
    a: >-
      Michael C. Hall returns as Dexter Morgan. Uma Thurman will reprise her
      role as Charley, and Krysten Ritter is also set to return.
  - q: 'When did the first season of ''Dexter: Resurrection'' premiere?'
    a: >-
      The first season of 'Dexter: Resurrection' premiered on July 13, 2025, on
      Paramount+.
about:
...
signals:
  ...
  trending: 8
  softTv: 0
eventSlug: dexter-resurrection-season-2-casting-gabriel-luna
eventType: casting
outletCount: 2
provenance:
  eventSlug: dexter-resurrection-season-2-casting-gabriel-luna
  primaryEntity: Gabriel Luna
  eventType: casting
  sensitivity: normal
  status: DEVELOPING
  ...
  outlets:
    - THR
    - Variety
  publishedAt: '2026-07-15T21:00:38.157Z'
dateModified: '2026-07-15T21:00:38.157Z'
storyStatus: DEVELOPING
newsType: general
pullQuote:
  text: >-
    He’ll be playing a character named Ray Ballard, a serial killer with the
    moniker “The Sleepy-Eyed Stranger.”
  attribution: The Hollywood Reporter
keyPoints:
  - 'Gabriel Luna is joining the cast of ''Dexter: Resurrection'' Season 2.'
  - He will play a serial killer called 'The Sleepy-Eyed Stranger.'
  - >-
    The series streams on Paramount+ and continues Dexter's story in New York
    City.
seriesContext:
  network: Paramount+
  premiere: '2025'
...
seriesStatus:
  ...
  castAdded:
    - name: Gabriel Luna
      role: Ray Ballard / The Sleepy-Eyed Stranger
---
