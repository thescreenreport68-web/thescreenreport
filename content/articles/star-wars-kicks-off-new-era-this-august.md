---
title: Star Wars Launches New Era With 'The Ninth Jedi' Anime Series in August
slug: star-wars-kicks-off-new-era-this-august
category: tv
subcategory: trailers
author: editorial-team
date: '2026-07-03T12:16:14.188Z'
dek: >-
...
tags:
  ...
  - nawaam
  - jedi
targetKeyword: star wars
keyTakeaways:
  - 'The series premieres exclusively on Disney+ and Hulu on August 5, 2026.'
  - >-
    It continues the story from the 'Visions' short 'The Ninth Jedi,' following
    Kara's search for her father and a fight against a new villain.
  - >-
    Directed by Kenji Kamiyama, the series is a non-canon anime spinoff
    exploring the blurred line between the Jedi and Sith.
  - >-
    The show's central concept involves lightsabers that change color based on
    the wielder's heart and allegiance to the Force.
faq:
  - q: Is The Ninth Jedi part of the main Star Wars canon?
    a: >-
      No, it is not. Like all entries in the Star Wars: Visions anthology, The
      Ninth Jedi is a non-canon story. This gives the creators, including
      director Kenji Kamiyama and studio Production I.G, greater freedom to
      explore unique concepts—like emotion-reactive lightsabers—without being
      constrained by the established timeline and rules of the core films and
      series.
  - q: What makes the lightsabers in this series different?
    a: >-
      The lightsabers, forged by the smith Lah Zhima, are a direct reflection of
      the wielder's heart and soul. They can change color dynamically, even
      during combat, without the traditional process of bleeding or healing a
      Kyber crystal. This means a Jedi's blade could turn red if they embrace
      anger or fear, while a fallen warrior's could shift back to a Jedi color
      if they return to the light, visually representing the fluid nature of
      one's connection to the Force.
  - q: Who is the villain Nawaam?
    a: >-
      Nawaam is a new, terrifying masked antagonist who confronts Kara and her
      fellow Jedi. Intriguingly, reports note that Nawaam wields a blue
      lightsaber, which traditionally signifies a Jedi. This, coupled with the
      series' theme of morally ambiguous weapons, suggests Nawaam may not be a
      straightforward Sith lord, adding a layer of mystery to the conflict.
about:
...
signals:
  ...
  pop: 0
  breakout: 0
eventSlug: star-wars-new-era-august
...
keyMoments:
  ...
  - >-
    Continues the story from the 'Star Wars: Visions' shorts 'The Ninth Jedi'
    and 'Child of Hope'.
  - >-
    Follows Kara's quest to find her kidnapped father, the lightsabersmith Lah
    Zhima.
  - 'Introduces a new masked villain, Nawaam, who wields a blue lightsaber.'
  - >-
    Features lightsabers that change color based on the wielder's heart and
    Force allegiance.
reveals:
  - term: ''
    note: ''
officialSynopsis: >-
  Kara and her ragtag Jedi crew seek out to find worthy Jedi to fight against an
  increasingly powerful warlord.
seriesContext:
  network: 'Disney+, Hulu'
